import "./chunk-C74XT27A.js";
import "./chunk-UIAFM2ZE.js";
import {
  init,
  throttle
} from "./chunk-RTKPXFJH.js";
import "./chunk-OKVEI4P2.js";
import {
  Teleport,
  computed,
  defineComponent,
...
function useSlotOption(slots, onSlotsChange) {
  ...
  const teleportedSlots = () => {
    return isMounted.value && detachedRoot ? h(Teleport, { to: detachedRoot }, Object.entries(slots).filter(([key]) => isValidSlotName(key)).map(([key, slot]) => {
      const slotName = key;
      const slotContent = initialized[slotName] ? slot == null ? void 0 : slot(params[slotName]) : void 0;
      return h("div", {
